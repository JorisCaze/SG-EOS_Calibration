...
void readFile(std::string const &file1, std::string const &file2, std::vector<double> &tab1, std::vector<double> &T_tab1, std::vector<double> &tab2, std::vector<double> &T_tab2);
